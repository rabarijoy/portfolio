...
export default function HomePage() {
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div 
        className="absolute bottom-0 left-0 right-0 w-full h-[200px] bg-blue-accent rounded-full transform translate-y-1/2 blur-[100px] pointer-events-none will-change-[filter]"
        style={{ 
          zIndex: 0,
