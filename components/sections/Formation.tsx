                    ...
                    <button className="techwatch-card-arrow" type="button" title="Click here">
                      <div className="techwatch-card-arrow-icon">
                        <svg width="31" height="28" viewBox="0 0 31 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M0.857198 13.7372L27.9141 13.7372" stroke="white" strokeWidth="3" strokeLinecap="round"/>
                          <path d="M15.4561 1.39417L27.9142 13.8522L15.4561 26.3104" stroke="white" strokeWidth="3" strokeLinecap="round"/>
                        </svg>
                      </div>
                    </button>
                  </div>
