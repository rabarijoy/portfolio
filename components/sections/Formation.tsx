            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              ...
              <div className="card-formation">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  <div>
                    <h4 style={{ fontFamily: "'PP Neue Montreal', Arial, sans-serif", fontWeight: 700, fontSize: '16px', color: '#000000', marginBottom: '12px' }}>
              ...
              return (
                ...
                >
                  ...
                  <div className="card-formation">
                    ...
                    {/* Resources Section */}
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                      <h4 style={{ fontFamily: "'PP Neue Montreal', Arial, sans-serif", fontWeight: 600, fontSize: '16px', color: '#000000', marginBottom: '12px' }}>
                        Ressources
                      </h4>
